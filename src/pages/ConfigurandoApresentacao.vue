<template>
  <q-page padding>
    <!-- content -->
    <h4 class="text-color-black text-weight-bold">Configurando apresentação</h4>
    <div class="text-center">
      <q-img
        src="manual_limesurvey_cecom/configuracao_apresentacao/configuracao_apresentacao_01.png"
        style="widtg: 100%"
      />
      ...
      <q-img
        ...
        style="widtg: 100%"
      />
      <p>Figura 4 - <i>URL final do questionário</i></p>
    </div>
  </q-page>
</template>
